...
export function InvitationHero() {
  ...
  return (
    ...
    >
      {/* Enhanced image animation with slower, more cinematic timing */}
      <motion.div
      ...
      {/* Subtle Lottie overlay for delicate animation */}
      ...
      <div className="relative z-20 text-center px-8 flex flex-col items-center justify-center h-full w-full">
        {/* Oversized, dramatic typography for mobile-first impact */}
        <motion.div
        ...
        {/* Refined scroll indicator with smoother animation */}
        <motion.div
        ...
        >
          ...
          >
            <span className="text-[8px] uppercase tracking-[0.8em] font-sans font-light text-white/30">Begin</span>
